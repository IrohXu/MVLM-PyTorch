...
class VisualTransformer(nn.Module):
    def __init__(
        ...
        # self.positional_embedding_mae = nn.Parameter(scale * torch.randn(self.grid_size[0] * self.grid_size[1], width))
    ...
    def forward(self, x: torch.Tensor, mask=None):
        ...
        if mask != None:
            ...
            pos_embed = self.positional_embedding[1:, :].to(x.dtype)
            B, N, C = x.shape
